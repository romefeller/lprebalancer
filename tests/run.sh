...
if [ $# -gt 0 ]; then
  ...
  python3 -m unittest -v test_engine test_rebalancer test_db test_calm test_payout test_rewards test_regime test_hardening test_venues test_touches test_signer_live
fi
